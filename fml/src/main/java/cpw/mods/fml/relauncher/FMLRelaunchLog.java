...
// import java.io.FileNotFoundException; // Unscrew: Remove import
import java.io.IOException;
import java.io.PrintStream;
// import java.util.concurrent.Executors; // Unscrew: Remove import
...
{
	// Unscrew start
	public static final String logFileNamePattern = "UnscrewLauncher-%g.log";
	// Unscrew end
    ...
    private static void configureLogging()
    {
        ...
        try
        {
            File logPath = new File(minecraftHome, logFileNamePattern); // Unscrew: FMLRelauncher.logFileNamePattern -> logFileNamePattern
