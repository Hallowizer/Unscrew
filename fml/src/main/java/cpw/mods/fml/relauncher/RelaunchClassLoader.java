...
// import java.io.ByteArrayOutputStream; // Unscrew: Remove unused import
...
public class RelaunchClassLoader extends URLClassLoader
{
    ...
    private Map<String, Class<?>> cachedClasses; // Unscrew: Map<String, Class> -> Map<String, Class<?>>
    ...
    public RelaunchClassLoader(URL[] sources)
    {
        ...
        this.cachedClasses = new HashMap<>(1000); // Unscrew: HashMap<String,Class> -> HashMap<>
...
//        ReflectionHelper.setPrivateValue(ClassLoader.class, null, this, "scl");
    ...
    public Class<?> findClass(String name) throws ClassNotFoundException
    {
        ...
        try
        {
            ...
            // String pkgPath = pkgname.replace('.', '/'); // Unscrew: Remove unused local variable.
    ...
    public void addClassLoaderExclusion(String toExclude) // Unscrew: private -> public
    {
        classLoaderExceptions.add(toExclude);
    }

    public void addTransformerExclusion(String toExclude) // Unscrew: default -> public
    {
